          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">Full access to all courses and coaching sessions</p>
              </div>
      ...
      <Card className="border-yellow-200 bg-yellow-50">
        ...
        <CardContent>
          <p className="text-yellow-700">
            Your subscription will automatically renew on July 1, 2024. You can cancel anytime before the renewal date
